...
import ModalCourses from '../CoursesSection/modal';
import "./index.css";
...
export default function CoursesSection({ showAll = false, customCourses = null }) {
    ...
    return (
        <>
                                        ...
                                        <div className="classSkew">
                                            ...
                                            <Card.Body className="p-0">
                                                ...
                                                <div className="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <Button className="readMore border-0" onClick={() => { handleShow(course) }}>
                                                        <span>Read More</span>
                                                    </Button>
                                                </div>
                                            </Card.Body>
            ...
            <ModalCourses show={show} handleClose={handleClose} singleCourse={singleCourse} />
        </>
    );
}