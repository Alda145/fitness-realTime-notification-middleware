...
export default function EditTrainer() {
    ...
    const { getOneTrainer, updateTrainer } = useTrainerContext();
    ...
    useEffect(() => {
        const fetchTrainer = async () => {
            try {
                const result = await getOneTrainer(id);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const result = await updateTrainer(id, value, file);
    ...
    return (
        <div className="container-fluid p-0">
            <div className="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                <div>
                    <h2 className="page-title mb-1">Edit Trainer</h2>
